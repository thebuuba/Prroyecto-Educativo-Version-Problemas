...
export function renderAttendancePanel(container, group, monthKey, deps) {
  const {
...
export function renderAttendanceEmpty(container) {
  container.innerHTML = `
...
function renderTableHeaders(sectionId, monthKey, deps) {
...
function renderTableRows(sectionId, monthKey, students, deps) {
...
function renderAttendanceCells(sectionId, monthKey, student, deps) {
...
function updateStats(sectionId, monthKey, students, deps) {
