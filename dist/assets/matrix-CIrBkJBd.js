import{s as k,S as b,C as v,g as $,e as c,f as g,D as y,h as E,B as h,j as C,p as z,c as A,d as j}from"./main-DzuOqHLs.js";function f(){return`
    <header class="mb-10 animate-in fade-in slide-in-from-top-4 duration-500">
      <div class="flex items-center justify-between gap-6">
        ...
        <div class="hidden md:flex flex-col items-end">
           <div class="text-xs font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">${C(b.activeGroupId)}</div>
           <div class="text-sm font-bold text-blue-600">${z()}</div>
        </div>
      </div>
    </header>
  `}function B(d){return`
  ...
  `}function M(d){const p=k(b.activeGroupId);if(p.length===0||v()===0){d.innerHTML=`
