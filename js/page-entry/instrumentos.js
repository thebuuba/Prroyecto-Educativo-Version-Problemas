/**
 * Punto de entrada específico para la ruta de Instrumentos de Evaluación.
 * --------------------------------------------------------------------------
 * Este script se encarga de:
 * 1. Definir la ruta activa y el panel a cargar (instrumentos).
...
window.__AULABASE_PAGE_ENTRY = { route: 'instrumentos', panel: 'instrumentos' };
...
(function loadAulaBaseSplitBundles() {
  ...
  var bundleQueue = [
    ...
    { key: 'instrumentos', src: '/js/bundles/panel-instrumentos.js?v=20260405i' },
  ...
  function loadNextBundle() {
    ...
    script.async = false;
    script.dataset.aulabaseEntry = 'instrumentos';
