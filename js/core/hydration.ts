...
} from './hydration/persistence.ts';
import {
  hydrateCloudStateForUser,
  hydrateLocalWorkspaceForUser,
  logoutAuth,
  resetToSignedOutState,
} from './hydration/session-flow.ts';
import {
...
} from './hydration/academic-state.ts';

type HydrateOptions = {
  skipRootState?: boolean;
};
 ...
 */
function migrateLegacyState(S: MutableState, changed: boolean): void {
