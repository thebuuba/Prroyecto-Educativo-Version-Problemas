...
export function subjectsForArea(level, areaName) {
 ...
 */
export function renderizarGradeSetupPanel(container) {
 ...
 */
export function actualizarGradeGrid() {
 ...
 */
export function actualizarAreaGrid() {
...
export function actualizarSectionGrid() {
