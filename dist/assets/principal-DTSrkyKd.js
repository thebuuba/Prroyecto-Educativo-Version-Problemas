import{t as l,f as d,S as r}from"./main-DiLCuoHx.js";const t={gradeId:"",section:"A",area:"",subject:"",room:""};function n(a){const s=d();if(s.length===0){l("Crea un grado antes de agregar asignaturas",!0),setTimeout(()=>window.go("grade-setup"),500);return}t.gradeId||(t.gradeId=r.activeGradeId||s[0].id),a.innerHTML=`
