import{S as t,g as i,a as v,b as m,e as f,s as k,c as S,d as y,f as r}from"./main-BFkCmjLr.js";let h="grid";function G(){return h}function I(){window.setStudentsGradeView=s=>{t.activeGradeId=s,i("estudiantes")},window.setActiveSection=s=>{t.activeGroupId=s,t.activeCourseId=s,i("estudiantes")},window.setStudentsViewMode=s=>{h=s==="table"?"table":"grid",i("estudiantes")},window.setStudentsGlobalSearch=s=>{window.STUDENTS_GLOBAL_QUERY=s,i("estudiantes")},window.openStudentSearchResult=s=>{const a=(t.estudiantes||[]).find(l=>l.id===s);if(!a)return;a.gradeId&&(t.activeGradeId=a.gradeId);const n=a.courseId||a.sectionId||a.seccionId;n&&(t.activeGroupId=n,t.activeCourseId=n),window.STUDENTS_GLOBAL_QUERY="",window.openViewStudent(s)},window.openEditStudent=s=>{t.editingStudentId=s,i("student-edit")}}function $(s){var g,w;const a=v(),n=m();if(a.length===0){s.innerHTML=`
    ...
    `;return}f();const l=a.some(e=>e.id===t.activeGradeId)?t.activeGradeId:((g=a[0])==null?void 0:g.id)||null;t.activeGradeId=l;const p=a.find(e=>e.id===l)||a[0],o=k(n.filter(e=>e.gradeId===p.id));o.some(e=>e.id===t.activeGroupId)||(t.activeGroupId=((w=o[0])==null?void 0:w.id)||null);const d=o.find(e=>e.id===t.activeGroupId)||o[0];t.activeGroupId=(d==null?void 0:d.id)||null;const c=d?S(d.id):[],u=window.STUDENTS_GLOBAL_QUERY||"",x=y(u),b=G();s.innerHTML=`
    <div class="p-6 max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <aside class="space-y-4">
          ...
          <div class="space-y-2">
            ${o.map(e=>renderSectionMiniCard(e,d==null?void 0:d.id)).join("")}
  ...
  `}function R(){window.RENDERS||(window.RENDERS={}),window.RENDERS.estudiantes=$,I()}export{R as inicializar,$ as registrarStudentsPanel};
