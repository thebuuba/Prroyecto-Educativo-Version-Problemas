import{t as n,s as c,b as u,S as p,a2 as r}from"./main-BFkCmjLr.js";function b({FormState:s,updatePreviews:a}){window.updateStudentCreateField=(t,e)=>{if(t==="matricula"){e=e.replace(/\D/g,"").slice(0,9),e.length>2&&(e=`${e.slice(0,2)}-${e.slice(2)}`),e.length>7&&(e=`${e.slice(0,7)}-${e.slice(7)}`);const l=document.getElementById("sc-mat");l&&(l.value=e)}s[t]=e,a()},window.handleStudentCreatePhoto=t=>{var i;const e=(i=t==null?void 0:t.files)==null?void 0:i[0];if(!e){s.photoUrl="",a();return}const l=new FileReader;l.onload=o=>{s.photoUrl=o.target.result,a()},l.readAsDataURL(e)},window.confirmSaveStudent=async(t=!1)=>{if(typeof window.saveEst!="function"){n("Error: Motor de guardado no disponible",!0);return}try{const e=(l,i)=>{const o=document.getElementById(l);o&&(o.value=i)};if(e("e-nom",s.nombre),e("e-ape",s.apellido),e("e-mat",s.matricula),e("e-sec",s.courseId),e("e-photo-data",s.photoUrl),await window.saveEst({keepOpen:t}),t){s.nombre="",s.apellido="",s.matricula="",s.photoUrl="";const l=document.getElementById("sc-nom"),i=document.getElementById("sc-ape"),o=document.getElementById("sc-mat");l&&(l.value="",l.focus()),i&&(i.value=""),o&&(o.value=""),a()}else window.go("estudiantes")}catch(e){console.error("[EduGest][student-create] Error:",e),n("Error al guardar estudiante",!0)}}}const d={nombre:"",apellido:"",matricula:"",courseId:"",photoUrl:""};function m(s){const a=c(u());if(a.length===0){n("Crea una sección antes de registrar estudiantes",!0),setTimeout(()=>window.go("section-create"),500);return}d.courseId||(d.courseId=p.activeGroupId||a[0].id),s.innerHTML=`
        ...
        <div class="lg:col-span-8 space-y-8">
          ...
          <section class="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-sm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              ${a.map(t=>{const e=d.courseId===t.id;return`
                  <button 
                    onclick="window.updateStudentCreateField('courseId', '${t.id}')"
                  ...
                  >
                    <div class="font-black text-slate-900 leading-tight">${t.grado} ${t.sec}</div>
                    <div class="text-[10px] font-bold text-slate-400 uppercase tracking-wider mt-1 truncate">${t.materia}</div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-8">
               <div class="relative group">
                 <div class="w-40 h-40 rounded-[2.5rem] overflow-hidden bg-slate-100 border-4 border-white shadow-xl">
                    <img id="sc-photo-preview" src="${r("")}" class="w-full h-full object-cover">
                 </div>
               ...
               <div class="relative z-10">
                 ...
                 <div class="flex flex-col items-center text-center">
                    <div class="w-24 h-24 rounded-3xl overflow-hidden bg-white/10 mb-6 border-2 border-white/20">
                       <img id="preview-student-photo" src="${r("")}" class="w-full h-full object-cover">
                    </div>
  ...
  `,updatePreviews()}function f(){b({FormState:d,updatePreviews}),window.RENDERS||(window.RENDERS={}),window.RENDERS["student-create"]=renderStudentCreatePanel}export{f as inicializar,m as renderizarStudentCreatePanel};
