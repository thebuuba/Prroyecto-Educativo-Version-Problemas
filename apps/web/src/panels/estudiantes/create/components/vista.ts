 ...
 */
export function renderizarStudentCreatePanel(container) {
            ...
            <div class="bg-slate-900 rounded-[3rem] p-8 text-white shadow-2xl relative overflow-hidden">
               <div class="relative z-10">
                 ...
                 <div class="mt-10 space-y-3">
                    ...
                    <button data-action="navigate" data-route="estudiantes" class="w-full py-3 text-slate-500 hover:text-white rounded-2xl font-bold transition-all text-sm">
                      Cancelar
                    </button>
                 </div>
               </div>
