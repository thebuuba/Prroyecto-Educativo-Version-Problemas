...
function getAreaCatalogForCurrentGrade() {
  return AREA_SUBJECTS[getSelectedGradeLevel()] || AREA_SUBJECTS.Primaria;
}
...
export function init() {
  window.updateSectionCreateField = (field, value) => {
    ...
    if (field === 'area') {
      ...
      const catalog = getAreaCatalogForCurrentGrade().find((a) => a.area === value);
