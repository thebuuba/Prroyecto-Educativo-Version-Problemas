import{S as s,K as d,f as n,w as x,t as r,p as b,L as v}from"./main-BFkCmjLr.js";const l=["rubrica_analitica","lista_cotejo_a","lista_cotejo_b","escala_estimativa"],a={rubrica_analitica:{title:"Rúbrica Analítica",icon:"📊",desc:"Evaluación detallada por criterios y niveles."},lista_cotejo_a:{title:"Lista de Cotejo Simple",icon:"✅",desc:"Cumple / No cumple (binaria)."},lista_cotejo_b:{title:"Lista Ponderada",icon:"⚖️",desc:"Cotejo con pesos específicos por criterio."},escala_estimativa:{title:"Escala Estimativa",icon:"📈",desc:"Valoración cualitativa (Siempre... Nunca)."}},c={filters:{type:"",gradeId:"",subject:"",periodId:""}};function i(t){s.instruments||(s.instruments=[]);const e=y();t.innerHTML=`
  ...
  `}function w(t){const e=a[t.type]||{title:"Otro",icon:"📄"},o=d().find(m=>m.id===t.courseId),u=o?`${o.gradeName} ${o.sectionName}`:"--",p=o?o.materia:t.subjectName||"--";return`
    <tr class="group hover:bg-slate-50/50 transition-colors border-b border-slate-50 last:border-0">
      ...
      <td class="px-6 py-6">
        <div class="text-xs font-bold text-slate-600">${n(p)}</div>
