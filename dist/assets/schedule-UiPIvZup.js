import{S as u,K as g,L as w,e as k,t as $,M as S}from"./main-DGpyBctX.js";function T(){return["Lunes","Martes","Miércoles","Jueves","Viernes","Sábado","Domingo"]}function x(e){if(!e)return"--:--";const[t,a]=e.split(":").map(Number),l=t>=12?"PM":"AM";return`${t%12||12}:${String(a).padStart(2,"0")} ${l}`}function D(e){const{UI:t}=e;return t.activeTab==="schedule"?M(e):E(e)}function M({S:e}){const t=e.teacherPlanner.activeWeekdays,a=e.teacherPlanner.weeklySchedule;if(a.length===0)return`
