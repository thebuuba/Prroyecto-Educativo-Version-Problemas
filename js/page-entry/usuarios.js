/**
 * Punto de entrada específico para la ruta de Usuarios.
 * --------------------------------------------------------------------------
 * Este script se encarga de:
 * 1. Definir la ruta activa y el panel a cargar (usuarios).
...
window.__AULABASE_PAGE_ENTRY = { route: 'usuarios', panel: 'usuarios' };
...
(function loadAulaBaseSplitBundles() {
  ...
  function loadNextBundle() {
    ...
    script.async = false;
    script.dataset.aulabaseEntry = 'usuarios';
