// Entry point específico de la ruta /reportes/. Carga el núcleo común, el bundle del panel y luego el shell que arranca la app.
window.__AULABASE_PAGE_ENTRY = { route: 'reportes', panel: 'reportes' };
...
(function loadAulaBaseSplitBundles() {
  ...
  var bundleQueue = [
    ...
    { key: 'reportes', src: '/js/bundles/panel-reportes.js?v=20260405i' },
  ...
  function loadNextBundle() {
    ...
    script.async = false;
    script.dataset.aulabaseEntry = 'reportes';
