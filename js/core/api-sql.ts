...
import { isEnabled } from './api-sql/client.ts';
import {
...
} from './api-sql/academic-endpoints.ts';
import {
  applySqlProfileBundle,
  ensureSqlAcademicContext,
  getSqlStateContext,
} from './api-sql/context.ts';
import { loadStateBlock, syncStateBlock } from './api-sql/state-api.ts';
import { syncProfile as syncProfileRequest } from './api-sql/bootstrap.ts';
import {
  isSqlUuidLike,
  resolveGradeSqlId,
  resolveSectionSqlId,
...
export { getBaseUrl, isEnabled, request } from './api-sql/client.ts';
export { loadSchoolCatalog, syncProfile } from './api-sql/bootstrap.ts';
export {
  clearAttendanceMonth,
  createActivity,
  createGrade,
...
export { buildQuery } from './api-sql/query.ts';
export {
  cancelSqlAttendanceMonthSync,
  scheduleSqlAttendanceMonthSync,
  syncSqlAttendanceMonth,
} from './api-sql/attendance-sync.ts';
export { syncSqlActivityCreateOrUpdate } from './api-sql/activity-sync.ts';
export { loadStateBlock, syncStateBlock } from './api-sql/state-api.ts';
export {
  ensureSqlAcademicContext,
...
export { isSqlUuidLike } from './sql-id-utils.ts';
export {
  getSqlAuthSession,
  loginSqlAuth,
  logoutSqlAuth,
