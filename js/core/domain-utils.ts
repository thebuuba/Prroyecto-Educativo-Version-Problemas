...
import { EDUCATION_SECTIONS, EDUCATION_THEME_CLASS_BY_SECTION, EDUCATION_THEME_CLASS_BY_COMBINATION } from './constants.ts';
import { shouldScopeByEducationSection, matchesActiveEducationSection } from './theme-logic.ts';
...
export * from './instrument-logic.ts';
export * from './academic-logic.ts';
export * from './api-mappings.ts';
export * from './theme-logic.ts';
export * from './academic-context-logic.ts';
export * from './curriculum-logic.ts';
export * from './planning-logic.ts';
export * from './grade-logic.ts';
export * from './sync-logic.ts';
import * as SQL from './api-sql.ts';
export { SQL as AulaBaseSqlApi };

import { ensurePeriodBuckets, studentsInGroup } from './academic-context-logic.ts';
import { fixMojibakeText } from './utils.ts';

// Re-exportes auxiliares para shell, root y paneles
export { getDisplayUserName, resetToSignedOutState, logoutAuth, persist } from './hydration.ts';
export { initials, openM, closeM, toast, forceCloseM, periodName } from './ui.ts';
export { go, currentPage } from './routing.ts';
export { 
  toggleDarkMode, 
...
export { STATIC_DOM, DEFAULT_PERIODS } from './constants.ts';
export { emptyGroupCfg } from './config.ts';
