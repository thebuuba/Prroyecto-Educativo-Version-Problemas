/**
 * Punto de entrada específico para la ruta de Estudiantes.
 * --------------------------------------------------------------------------
 * Este script se encarga de:
 * 1. Definir la ruta activa y el panel a cargar (estudiantes).
 * 2. Cargar secuencialmente los bundles necesarios (Núcleo, Shell).
