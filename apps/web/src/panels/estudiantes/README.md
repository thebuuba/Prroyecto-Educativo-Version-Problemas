...
Fuente modular real del dominio estudiantes.

Subdominios incluidos:

- `.`: listado, filtros, busqueda y registry `data-student-action`.
- `create/`: panel `student-create` y `FormState` local de alta.
- `edit/`: panel `student-edit` y `FormState` local de edicion.
...
- `utils/student-dom-fields.ts`: lectura/escritura DOM simple de campos legacy de crear, vista y edicion.
