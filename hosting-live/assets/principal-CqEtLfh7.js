import{S as t,g as i,a as v,b as m,e as f,s as k,c as S,d as y,f as r}from"./main-WukIV6bs.js";let h="grid";function G(){return h}function I(){window.setStudentsGradeView=s=>{t.activeGradeId=s,i("estudiantes")},window.setActiveSection=s=>{t.activeGroupId=s,t.activeCourseId=s,i("estudiantes")},window.setStudentsViewMode=s=>{h=s==="table"?"table":"grid",i("estudiantes")},window.setStudentsGlobalSearch=s=>{window.STUDENTS_GLOBAL_QUERY=s,i("estudiantes")},window.openStudentSearchResult=s=>{const a=(t.estudiantes||[]).find(l=>l.id===s);if(!a)return;a.gradeId&&(t.activeGradeId=a.gradeId);const o=a.courseId||a.sectionId||a.seccionId;o&&(t.activeGroupId=o,t.activeCourseId=o),window.STUDENTS_GLOBAL_QUERY="",window.openViewStudent(s)},window.openEditStudent=s=>{t.editingStudentId=s,i("student-edit")}}function E(s){var g,w;const a=v(),o=m();if(a.length===0){s.innerHTML=`
    ...
    `;return}f();const l=a.some(e=>e.id===t.activeGradeId)?t.activeGradeId:((g=a[0])==null?void 0:g.id)||null;t.activeGradeId=l;const p=a.find(e=>e.id===l)||a[0],n=k(o.filter(e=>e.gradeId===p.id));n.some(e=>e.id===t.activeGroupId)||(t.activeGroupId=((w=n[0])==null?void 0:w.id)||null);const d=n.find(e=>e.id===t.activeGroupId)||n[0];t.activeGroupId=(d==null?void 0:d.id)||null;const c=d?S(d.id):[],u=window.STUDENTS_GLOBAL_QUERY||"",x=y(u),b=G();s.innerHTML=`
