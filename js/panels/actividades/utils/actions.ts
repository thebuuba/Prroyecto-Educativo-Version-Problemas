...
export function updateBlockMeta(blockId, value) {
...
export async function handleActNameInput(blockId, activityId, input) {
...
export async function updateActPts(blockId, activityId, value) {
...
export async function addActToBlock(blockId) {
...
export async function removeActFromBlock(blockId, activityId) {
...
export function autoAdjustBlock(blockId) {
  const cfg = getGroupCfg(S.activeGroupId)[blockId];
...
export function registerActivitiesActions() {
  window.setActView = setActView;
  window.updateBlockMeta = updateBlockMeta;
  window.handleActNameInput = handleActNameInput;
  window.updateActPts = updateActPts;
