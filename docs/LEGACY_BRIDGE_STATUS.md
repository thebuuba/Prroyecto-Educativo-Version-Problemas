...
- Lectura/escritura DOM simple de modales y bulk fue encapsulada en `student-dom-fields.ts`; el parser textual simple vive en `student-bulk-parser.ts`, mientras `student-logic.ts` conserva mensajes, estado, SQL, persistencia, modales y navegación.
