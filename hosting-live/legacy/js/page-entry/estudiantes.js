// Entry point específico de la ruta /estudiantes/. Carga el núcleo común, el bundle del panel y luego el shell que arranca la app.
window.__AULABASE_PAGE_ENTRY = { route: 'estudiantes', panel: 'estudiantes' };
...
(function loadAulaBaseSplitBundles() {
  ...
  var bundleQueue = [
    ...
    { key: 'estudiantes', src: '/js/bundles/panel-estudiantes.js?v=20260405i' },
  ...
  function loadNextBundle() {
    ...
    script.async = false;
    script.dataset.aulabaseEntry = 'estudiantes';
